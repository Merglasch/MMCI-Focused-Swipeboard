...
public class FSBTopMiddle extends View {

    private Paint _focusedBoxesBackground = new Paint();

    public FSBTopMiddle(Context context) {
        super(context);
        init(null, 0);
    }

    public FSBTopMiddle(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public FSBTopMiddle(Context context, AttributeSet attrs, int defStyle) {

...
public class FSBTopRight extends View {

    private Paint _focusedBoxesBackground = new Paint();

    public FSBTopRight(Context context) {
        super(context);
        init(null, 0);
    }

    public FSBTopRight(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public FSBTopRight(Context context, AttributeSet attrs, int defStyle) {
